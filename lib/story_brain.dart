...
//TODO: Step 23 - Use the storyNumber property inside getStory(), getstoryChoice1() and getstoryChoice2() so that it gets the updated story and choices rather than always just the first (0th) one.
  int _storyNumber = 0;
